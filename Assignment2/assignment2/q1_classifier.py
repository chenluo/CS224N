...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(dtype=tf.float32, shape=[self.config.batch_size, self.config.n_features], name='input_placeholder')
        self.labels_placeholder = tf.placeholder(dtype=tf.float32, shape=[self.config.batch_size, self.config.n_classes], name='labels_placeholder')
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        w = tf.get_variable(initializer=tf.initializers.zeros, dtype=tf.float32, name="w", shape=[self.config.n_features, self.config.n_classes])
        b = tf.get_variable(initializer=tf.initializers.zeros, dtype=tf.float32, name="b", shape=[1, 1])
